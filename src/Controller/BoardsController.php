...
class BoardsController extends AppController
{
    ...
    public function add()
    {
        ...
        if ($this->request->is('post')) {
            ...
            if ($this->Boards->save($board)) {
                $this->Flash->success('The board has been saved.');
                return $this->redirect(['action' => 'index']);
            } else {
                $this->Flash->error('The board could not be saved. Please, try again.');
            }
        }
    ...
    public function delete($id = null)
    {
        ...
        if ($this->Boards->delete($board)) {
            $this->Flash->success('The board has been deleted.');
        } else {
            $this->Flash->error('The board could not be deleted. Please, try again.');
        }
        return $this->redirect(['action' => 'index']);
    }
}
