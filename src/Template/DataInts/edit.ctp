<div class="actions columns large-2 medium-3">
    ...
    <ul class="side-nav">
        <li><?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $dataInt->id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $dataInt->id)]
            )
        ?></li>
...
<div class="dataInts form large-10 medium-9 columns">
    <?= $this->Form->create($dataInt); ?>
    <fieldset>
        <legend><?= __('Edit Data Int') ?></legend>
        <?php
