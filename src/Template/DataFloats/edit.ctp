<div class="actions columns large-2 medium-3">
    ...
    <ul class="side-nav">
        <li><?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $dataFloat->id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $dataFloat->id)]
            )
        ?></li>
...
<div class="dataFloats form large-10 medium-9 columns">
    <?= $this->Form->create($dataFloat); ?>
    <fieldset>
        <legend><?= __('Edit Data Float') ?></legend>
        <?php
