<div class="actions columns large-2 medium-3">
    ...
    <ul class="side-nav">
        <li><?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $dataText->id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $dataText->id)]
            )
        ?></li>
...
<div class="dataTexts form large-10 medium-9 columns">
    <?= $this->Form->create($dataText); ?>
    <fieldset>
        <legend><?= __('Edit Data Text') ?></legend>
        <?php
